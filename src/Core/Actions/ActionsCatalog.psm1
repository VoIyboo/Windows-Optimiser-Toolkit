...
$null = Import-QOTOptionalModule -Path (Join-Path $PSScriptRoot "..\Logging\Logging.psm1") -ImporterContext 'ActionsCatalog' -Force
$null = Import-QOTOptionalModule -Path (Join-Path $PSScriptRoot "ActionRegistry.psm1")     -ImporterContext 'ActionsCatalog' -Global
...
function Initialize-QOTActionCatalog {
    ...
    $actionDefinitions = @(
        @{ ActionId = "Invoke-QCleanTemp"; Label = "Deep clean temporary folders"; Script = "Cleanup\\Invoke-QCleanTemp.ps1" },
        ...
        @{ ActionId = "Invoke-QCleanPrefetchFiles"; Label = "Clear Prefetch files"; Script = "Cleanup\Invoke-QCleanPrefetchFiles.ps1" },
        @{ ActionId = "Invoke-QRefreshWindowsIconCache"; Label = "Refresh Windows icon cache"; Script = "Cleanup\Invoke-QRefreshWindowsIconCache.ps1" },
        @{ ActionId = "Invoke-QClearWindowsEventLogs"; Label = "Clear Windows Event Logs"; Script = "Cleanup\Invoke-QClearWindowsEventLogs.ps1" },
        @{ ActionId = "Invoke-QCleanTeamsCache"; Label = "Clear Microsoft Teams cache"; Script = "Cleanup\Invoke-QCleanTeamsCache.ps1" },
        ...
        @{ ActionId = "Invoke-QTweakDisableGameDVR"; Label = "Disable Game DVR"; Script = "Tweaks\Invoke-QTweakDisableGameDVR.ps1" },
        @{ ActionId = "Invoke-QTweakDisableWindowsConsumerFeatures"; Label = "Disable Windows consumer features"; Script = "Tweaks\Invoke-QTweakDisableWindowsConsumerFeatures.ps1" },
        @{ ActionId = "Invoke-QTweakDisableWindowsRecall"; Label = "Disable Windows Recall"; Script = "Tweaks\Invoke-QTweakDisableWindowsRecall.ps1" },
        ...
        @{ ActionId = "Invoke-QCleanComponentStore"; Label = "Clean Windows Component Store"; Script = "Cleanup\\Invoke-QCleanComponentStore.ps1" },
        @{ ActionId = "Invoke-QAggressiveComponentStoreCleanup"; Label = "Aggressive component store cleanup"; Script = "Cleanup\\Invoke-QAggressiveComponentStoreCleanup.ps1" },
        @{ ActionId = "Invoke-QScanUnusedDeviceDrivers"; Label = "Scan unused device drivers (report only)"; Script = "Cleanup\\Invoke-QScanUnusedDeviceDrivers.ps1" },
        @{ ActionId = "Invoke-QDisableTelemetryScheduledTasks"; Label = "Disable telemetry scheduled tasks"; Script = "Cleanup\\Invoke-QDisableTelemetryScheduledTasks.ps1" },
        @{ ActionId = "Invoke-QNetworkReset"; Label = "Network reset"; Script = "Network\\Invoke-QNetworkReset.ps1" },
        @{ ActionId = "Invoke-QFlushDnsCache"; Label = "Flush DNS cache"; Script = "Network\\Invoke-QFlushDnsCache.ps1" },
        @{ ActionId = "Invoke-QResetWinsock"; Label = "Reset Winsock"; Script = "Network\\Invoke-QResetWinsock.ps1" },
        @{ ActionId = "Invoke-QResetWindowsFirewall"; Label = "Reset Windows Firewall"; Script = "Network\\Invoke-QResetWindowsFirewall.ps1" },
        @{ ActionId = "Invoke-QRestartWindowsExplorer"; Label = "Restart Windows Explorer"; Script = "Network\\Invoke-QRestartWindowsExplorer.ps1" },
        @{ ActionId = "Invoke-QRebuildWindowsSearchIndex"; Label = "Rebuild Windows Search index"; Script = "Network\\Invoke-QRebuildWindowsSearchIndex.ps1" },
        @{ ActionId = "Invoke-QRunSfcSystemFileRepair"; Label = "Run SFC system file repair"; Script = "Network\\Invoke-QRunSfcSystemFileRepair.ps1" },
        @{ ActionId = "Invoke-QRunDismHealthRepair"; Label = "Run DISM health repair"; Script = "Network\\Invoke-QRunDismHealthRepair.ps1" }
    )
